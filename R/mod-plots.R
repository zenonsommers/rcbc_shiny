# ==============================================================================
# mod-plots.R — Candidate Preference Plots
# ==============================================================================

# ==============================================================================
# Plot Rendering Server Function
# ==============================================================================
...
mod_plots_server <- function(id, session) {
  moduleServer(id, function(input, output, session) {
    ...
    # Reactive observer to generate and display candidate preference plots
    # Called from both process pages (p1 and p2)
    observe({
...
# ==============================================================================
# Ballot Data Reactive (needed by plots module)
# ==============================================================================

# This is defined inline in server.R where it's needed,
# but the structure is documented here for reference.
# The reactive reads all ballot JSON files for the active election
